...
function Chart({ coinId }: coinIdProps) {
  ...
  const { isLoading, data } = useQuery<IPriceData[]>(["ohlcv", coinId], () => fetchCoinHistory(coinId));
  return (
    <div>
      {
        isLoading ? "Loading chart..." :
          ...
          <Apexchart
            ...
            options={{
              ...
              xaxis: {
                labels: { show: true, style: { colors: "#888" } }, categories: data?.map(price => price.time_close), type: "datetime",
              },
